...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "rounded-full bg-surface-3 text-text-1 hover:bg-surface-3/80",
        outline:
          "rounded-[12px] border border-border-subtle bg-transparent text-text-1 hover:bg-surface-3 hover:text-text-1",
        ghost:
          "rounded-[10px] hover:bg-surface-3 hover:text-text-1",
