  ...
  return (
    <Card className="border-border-subtle bg-surface-1 p-5 backdrop-blur">
      <div className="mb-4 space-y-1">
        <h2 className="text-sm font-medium text-foreground/90">Distribuzione del reddito</h2>
              ...
              <tbody className="divide-y divide-border-subtle">
                {rows.map((s) => (
                  <tr key={s.key}>
                    ...
                    <td className="py-2 text-right text-foreground/90">{formatCurrency(s.value / 12)}</td>
                    <td className="py-2 text-right text-foreground/90">{formatCurrency(s.value)}</td>
