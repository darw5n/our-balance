    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div className="flex w-full items-center justify-between sm:w-auto sm:justify-start sm:gap-3">
          <a
            ...
            className="flex h-8 w-8 items-center justify-center rounded-lg border border-border-subtle text-text-2 transition-colors hover:bg-surface-hover hover:text-foreground"
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="text-xs text-text-2">Riepilogo entrate e uscite per il {safeYear}.</p>
          </div>
          {isFutureYear ? (
            <span
              className="flex h-8 w-8 cursor-not-allowed items-center justify-center rounded-lg border border-border-subtle/50 text-text-3/60"
              aria-disabled="true"
            >
      ...
      {viewMode === "family" ? (
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-xl border border-border-subtle bg-surface-1 p-4 backdrop-blur">
            <div className="flex items-start justify-between gap-2">
              <div className="space-y-1">
                <p className="text-xs text-text-2">Uscite {safeYear}</p>
                <p className="text-xl font-semibold text-rose-400">{formatCurrency(summary.uscite)}</p>
              </div>
              <div className="rounded-md border border-border-subtle bg-surface-hover p-1.5">
          ...
          <div className="rounded-xl border border-border-subtle bg-surface-1 p-4 backdrop-blur">
            <div className="flex items-start justify-between gap-2">
              <div className="space-y-1">
                <p className="text-xs text-text-2">Uscite medio/mese</p>
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          <div className="rounded-xl border border-border-subtle bg-surface-1 p-4 backdrop-blur">
            <div className="flex items-start justify-between gap-2">
              <div className="space-y-1">
                <p className="text-xs text-text-2">Entrate {safeYear}</p>
          ...
          <div className="rounded-xl border border-border-subtle bg-surface-1 p-4 backdrop-blur">
            <div className="flex items-start justify-between gap-2">
              <div className="space-y-1">
                <p className="text-xs text-text-2">Netto {safeYear}</p>
